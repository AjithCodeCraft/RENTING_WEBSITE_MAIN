...
import { getStatusColor, calculateDays } from '../../utils/bookingHelpers';
      ...
      <DialogContent sx={{ p: 3 }}>
        ...
        <Grid container spacing={3}>
          <Grid item xs={12} md={6}>
            ...
            <Typography variant="body1" fontWeight="medium" mt={1}>{booking.user}</Typography>
          ...
          <Grid item xs={12} md={6}>
            ...
            <Typography variant="body1" fontWeight="medium" mt={1}>{booking.apartment}</Typography>
            <Typography variant="body2">Room/Dormitory: {booking.room_number}</Typography>
          ...
          <Grid item xs={12} md={6}>
            ...
            <Box sx={{ display: 'flex', mt: 1 }}>
              <Box>
                ...
                <Typography variant="body1" fontWeight="medium">{booking.start_date}</Typography>
              </Box>
              <Box sx={{ mx: 2, display: 'flex', alignItems: 'center' }}>→</Box>
              <Box>
                <Typography variant="body2" color="text.secondary">Check-out</Typography>
                <Typography variant="body1" fontWeight="medium">{booking.end_date}</Typography>
              </Box>
            </Box>
          ...
          <Grid item xs={12} md={6}>
            ...
            <Typography variant="body1" fontWeight="medium" mt={1}>{booking.payment_method}</Typography>
            <Typography variant="body2">ID: {booking.payment_id}</Typography>
            <Typography variant="body2">Amount: {booking.total_amount}</Typography>
          </Grid>
        </Grid>
      </DialogContent>
