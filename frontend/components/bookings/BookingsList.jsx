            ...
            <Table sx={{ minWidth: 650 }}>
              <TableHead>
                <TableRow sx={{ backgroundColor: '#f5f5f5' }}>
                  <TableCell sx={{ fontWeight: 'bold', py: 2 }}>Booking ID</TableCell>
                  <TableCell sx={{ fontWeight: 'bold', py: 2 }}>Apartment</TableCell>
                  <TableCell sx={{ fontWeight: 'bold', py: 2 }}>User</TableCell>
                  <TableCell sx={{ fontWeight: 'bold', py: 2 }}>Booking Date</TableCell>
              ...
              <TableBody>
                {bookings.map((booking) => (
                  <TableRow key={booking.booking_id} hover>
                    <TableCell sx={{ py: 2 }}>{booking.booking_id.substring(0, 8)}...</TableCell>
