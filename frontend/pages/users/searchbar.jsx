...
export default function Searchbar() {
  ...
  const changeRoomType = (e) => {
      ...
      if (filters.roomSharingType === value) {
          setFilters({...filters, roomSharingType: ''});
      } else {
          setFilters({...filters, roomSharingType: value});
      }
  };
