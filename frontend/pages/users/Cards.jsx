  ...
  const CardDemo = () => {
    ...
    return (
      <div className="flex flex-col md:flex-row h-screen w-full p-4">
        ...
        {/* Right Section - Map */}
        <div className="w-full md:w-2/5 bg-gray-200 flex items-center justify-center rounded-xl mt-4 md:mt-0">
          <div className="relative w-full h-96 md:h-full bg-gray-200 rounded-xl flex items-center justify-center">
